...
#fruits_with_more_than_two_vowels=[if len(fruit)]
...
numeral=[number for number in numbers if len(str(number))>1 ]
# Exercise 15 - Make a variable named numbers_squared that contains the numbers list with each element squared. Output is [4, 9, 16, etc...]
number_squared=[number**2 for number in numbers]
print(number_squared)
# Exercise 16 - Make a variable named odd_negative_numbers that contains only the numbers that are both odd and negative.
oddneg=[number for number in numbers if number<0 and number%2==1]
print(oddneg)
# Exercise 17 - Make a variable named numbers_plus_5. In it, return a list containing each number plus five. 
plus_five=[number+5 for number in numbers]
